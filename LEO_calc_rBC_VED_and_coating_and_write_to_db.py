...
start_date = '20100105'
end_date = '20110830'
lookup_file = 'C:/Users/Sarah Hanna/Documents/Data/WHI long term record/coatings/lookup_tables/coating_lookup_table_WHI_2010_ECSP2-neg_coat.lupckl'
rBC_density = 1.8 
incand_sat = 3750
...
i = 0
for row in c.execute('''SELECT incand_amp, LF_scat_amp, unix_ts_utc, sp2b_file, file_index, instr FROM SP2_coating_analysis WHERE instr=? and instr_locn=? and particle_type=? and incand_amp<? and LF_scat_amp<? and unix_ts_utc>=? and unix_ts_utc<?''', (instrument,instrument_locn,type_particle,incand_sat,LF_max,begin_data,end_data)):
	incand_amp = row[0]
	LF_amp = row[1]
	...
	if rBC_mass >= 0.25 and rBC_mass < 10.05 and LF_amp < 45000 and LF_amp > 0:

...
plt.text(10000,10, 'Aquadag corrected fit:\nrBC mass = 0.41527 + 2.13238E-4*HG_pkht + 7.17406E-10*HG_pkht^2')
plt.text(12000,32, 'Aquadag corrected fit:\nrBC mass = -0.22690 +2.52001E-3*LG_pkht + 4.55884E-8*LG_pkht^2')

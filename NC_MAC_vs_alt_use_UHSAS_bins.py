...
##'ferry 1'    : [datetime(2015,4,6,9,0),  datetime(2015,4,6,11,0) ,'UHSAS_Polar6_20150406_R1_V1.ict'],  #flight data - merged not AIMMS
##'ferry 2'    : [datetime(2015,4,6,15,0), datetime(2015,4,6,18,0) ,'UHSAS_Polar6_20150406_R1_V2.ict'],  #flight data - merged not AIMMS
##'science 2'  : [datetime(2015,4,7,16,0), datetime(2015,4,7,21,0) ,'UHSAS_Polar6_20150407_R1_V1.ict'],  #flight data - merged not AIMMS
#'science 3'  : [datetime(2015,4,8,13,51), datetime(2015,4,8,16,44) ,'UHSAS_Polar6_20150408_R1_V1.ict'],  
'science 4'  : [datetime(2015,4,8,17,53),datetime(2015,4,8,22,44) ,'UHSAS_Polar6_20150408_R1_V2.ict'],
#'science 5'  : [datetime(2015,4,9,13,50),datetime(2015,4,9,17,48) ,'UHSAS_Polar6_20150409_R1_V1.ict'],
##'ferry 3'    : [datetime(2015,4,10,14,28),datetime(2015,4,10,16,44),'UHSAS_Polar6_20150410_R1_V1.ict'],
#'science 6'  : [datetime(2015,4,11,15,57),datetime(2015,4,11,21,17),'UHSAS_Polar6_20150411_R1_V1.ict'],
#'science 7'  : [datetime(2015,4,13,15,14),datetime(2015,4,13,20,53),'UHSAS_Polar6_20150413_R1_V1.ict'],
#'science 8'  : [datetime(2015,4,20,15,49),datetime(2015,4,20,19,50),'UHSAS_Polar6_20150420_R1_V1.ict'],
#'science 9'  : [datetime(2015,4,20,21,46),datetime(2015,4,21,1,37) ,'UHSAS_Polar6_20150420_R1_V2.ict'],
#'science 10' : [datetime(2015,4,21,16,7),datetime(2015,4,21,21,25),'UHSAS_Polar6_20150421_R1_V1.ict'],  ###
##'test'		  : [datetime(2015,4,9,13,50),datetime(2015,4,9,14,10),'UHSAS_Polar6_20150409_R1_V1.ict'],  ###
}
...
for flight_name, info in flight_times.iteritems():
	...
	os.chdir('C:/Users/Sarah Hanna/Documents/Data/Netcare/Spring 2015/UHSAS/UHSAS-R1/hold/')
	UHSAS_file = info[2]
	...
	for bin in bin_list:
		...
		file_data.append([bin_LL,bin_UL,UHSAS_number_mean_norm,SP2_coated_number_mean_norm,coat_th_mean,SP2_core_number_mean_norm,nonincand_number_mean_norm])
	...
	file = open(flight_name + ' - UHSAS and SP2 data binned data - by flight - v2.txt', 'w')
	if new_file == True:
		file.truncate(0)
		file.write('UHSAS and SP2 data from Netcare POLAR6 flights - Spring 2015\n')
		file.write('bin_lower_limit(nm),bin_upper_limit(nm), UHSAS_number_concentration(dN/dlogD #/sccm),SP2_number_concentration_using_core+coating_diamater(dN/dlogD #/sccm),SP2_mean_coating_thickness_for_rBC_cores_in_this_size_bin(nm),SP2_number_concentration_using_core_only_diamater(dN/dlogD #/sccm),SP2_nonincandescent_number_concentration(dN/dlogD #/sccm)\n')
	...
	nonincand_number = [row[6] for row in file_data]
	...
	ax1.scatter(bin_LL,nonincand_number, label = 'nonincand', color = 'm')

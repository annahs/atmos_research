...
ax2 = plt.subplot2grid((2,6), (0,1), colspan=1, sharey=ax1)
ax3 = plt.subplot2grid((2,6), (0,2), colspan=1, sharey=ax1)
ax4 = plt.subplot2grid((2,6), (0,3), colspan=1, sharey=ax1)
ax5 = plt.subplot2grid((2,6), (0,4), colspan=1, sharey=ax1)
ax11 = plt.subplot2grid((2,6), (0,5), colspan=1, sharey=ax1)
						
ax6 = plt.subplot2grid((2,6), (1,0), colspan=1)
ax7 = plt.subplot2grid((2,6), (1,1), colspan=1, sharey=ax6)
ax8 = plt.subplot2grid((2,6), (1,2), colspan=1, sharey=ax6)
ax9 = plt.subplot2grid((2,6), (1,3), colspan=1, sharey=ax6)
ax10 = plt.subplot2grid((2,6), (1,4), colspan=1, sharey=ax6)
...
ax1.text(0.6, 0.9,'NPac', transform=ax1.transAxes)
#ax1.set_ylim(0,40)
ax1.xaxis.tick_top()
...
ax2.text(0.4, 0.9,'SPac', transform=ax2.transAxes)
ax2.xaxis.tick_top()
...
ax3.text(0.4, 0.9,'GBPS', transform=ax3.transAxes)
ax3.xaxis.tick_top()
...
ax4.text(0.4, 0.9,'LRT', transform=ax4.transAxes)
ax4.xaxis.tick_top()
...
ax5.text(0.4, 0.9,'Cont', transform=ax5.transAxes)
ax5.xaxis.tick_top()

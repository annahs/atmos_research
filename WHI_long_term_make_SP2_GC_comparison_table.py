...
#pprint(the_table.__dict__)
		  
		  
	
os.chdir('C:/Users/Sarah Hanna/Documents/Data/WHI long term record/GOES-Chem/')
  
plt.savefig('GC default v10 vs SP2 by cluster for WHI - ' + case + ' - ' + str(RH_of_interest) + '% RH threshold.png')
plt.show()	
cnx.close()		
...
for cluster in clusters:
	...
	for case in cases:
		...
		p10_row.append(GC_10)
		p50_row.append(GC_50)
		p90_row.append(GC_90)
		mean_row.append(GC_mean)
...
colLabels=('cluster','percentile','default', 'Van', 'wet_scav', 'no_bb', 'all_changes')

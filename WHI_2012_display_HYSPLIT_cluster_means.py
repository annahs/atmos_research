...
dir ='C:/hysplit4/working/WHI/2hrly_HYSPLIT_files/all_with_sep_GBPS/'
os.chdir(dir)


cluster_no = 0	
for file in os.listdir('.'):
	if file.endswith('6mean.tdump'):
...
os.chdir('C:/Users/Sarah Hanna/Documents/Data/WHI long term record/coatings/HYSPLIT/')

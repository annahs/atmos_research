...
map.drawmapscale(lonStart+1, latStart+1, lon_0, latStart, 50, barstyle='simple', units='km', fontsize=12, yoffset=None, labelstyle='simple', fontcolor='k', fillcolor1='w', fillcolor2='k', ax=None, format='%d', zorder=None)
